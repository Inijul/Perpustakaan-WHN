            ...
            try {
                ...
                if (response.ok) {
                    ...
                    this.koleksiData = {
                        ...
                        // pakai sampul baru dari backend jika ada
                        sampul: (result?.data?.sampul ?? this.koleksiData.sampul)
                    };
                    
                    // Update selectedKategori juga
                    this.selectedKategori = formData.get('kategori');
                    // Cache-busting agar preview gambar langsung update
                    this.cacheBuster = Date.now();
                ...
                <div x-data="{ fileName: '' }" class="space-y-2">
                    ...
                    <template x-if="koleksiData?.sampul && koleksiData.sampul !== '' && koleksiData.sampul !== null">
                        <div class="mb-3">
                            ...
                            <img :src="'/storage/sampul/' + koleksiData.sampul + '?v=' + cacheBuster" 
