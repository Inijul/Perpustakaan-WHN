...
<head>
    ...
    <style>
        ...
        /* Page loading overlay - DISABLED untuk menghilangkan animasi blur putih */
...
<body class="min-h-screen bg-white" x-data style="opacity: 1 !important; transform: none !important; backdrop-filter: none !important; -webkit-backdrop-filter: none !important;">
    <div class="flex h-screen overflow-hidden" id="main-content" style="opacity: 1 !important; transform: none !important; animation: none !important;">
        <x-sidebar></x-sidebar>
        ...
        <div class="flex-1 p-4 md:p-8 flex flex-col gap-6">
            ...
            <div class="flex flex-wrap justify-start items-center gap-4 filter-container" x-data="filterData()" x-init="init()">
                ...
                <div class="relative w-full sm:w-[180px]">
                    ...
                    <div x-show="kategoriOpen" @click.away="kategoriOpen = false" class="absolute left-0 right-0 mt-2 bg-white rounded-[15px] shadow-lg border border-black overflow-hidden z-50">
                ...
                <div class="relative w-full sm:w-[180px]">
                    ...
                    <div x-show="tahunOpen" @click.away="tahunOpen = false; searchYear = ''" class="absolute left-0 right-0 mt-2 bg-white rounded-[15px] shadow-lg border border-black overflow-hidden z-50 max-h-80" style="overflow-x: hidden;">
                ...
                <div class="relative w-full sm:w-[180px]">
                    ...
                    <div x-show="statusOpen" @click.away="statusOpen = false" class="absolute left-0 right-0 mt-2 bg-white rounded-[15px] shadow-lg border border-black overflow-hidden z-50">
...
// Page loading optimization - DISABLED untuk menghilangkan animasi blur putih
document.addEventListener('DOMContentLoaded', function() {
    // Tampilkan konten segera tanpa penundaan/animasi
    const mainContent = document.getElementById('main-content');
    if (mainContent) {
        // Pastikan tidak ada animasi fade-in atau blur
        mainContent.classList.remove('fade-in', 'page-transition-enter');
