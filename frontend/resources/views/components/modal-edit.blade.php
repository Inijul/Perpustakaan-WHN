<div x-data="{ 
        ...
        async submitForm(event) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    alert('Gagal memperbarui koleksi: ' + errorText);
                }
            } catch (error) {
    ...
    <div class="bg-white rounded-[30px] w-full max-w-md mx-auto relative max-h-[95vh] border border-black overflow-hidden" 
        ...
        <form x-show="koleksiData" :action="`/koleksi/${koleksiData?.kode || ''}`" method="POST" enctype="multipart/form-data" @submit="submitForm($event)">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="judul" placeholder="Tuliskan Judul"
                    x-bind:value="koleksiData?.judul || ''"
            ...
            <div class="flex justify-between gap-4 mt-8">
                ...
                <button type="submit"
                    class="flex-1 bg-[#1976c5] text-white rounded-[30px] py-2 font-medium hover:bg-[#125a96]">Update Koleksi</button>
            </div>
        </form>
        </div>
    </div>
